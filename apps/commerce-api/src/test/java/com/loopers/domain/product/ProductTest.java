...
class ProductTest {
    ...
    void create_success() {
        ...
        // when
        Product product = Product.of(1L,name, description, price, ProductStatus.AVAILABLE, quantity,1L);
    ...
    void invalid_price(int invalidPrice) {
        // when & then
        assertThatThrownBy(() ->
            Product.of(1L,"상품명", "상품 설명", BigDecimal.valueOf(invalidPrice), ProductStatus.AVAILABLE, 10,1L)
    ...
    void  invalid_stock() {
        // given
        Product product = Product.of(1L,"상품명", "상품 설명", BigDecimal.valueOf(5000), ProductStatus.UNAVAILABLE, 10,1L);
    ...
    void invalid_status() {
        // given
        Product product = Product.of(1L,"상품명", "상품 설명", BigDecimal.valueOf(5000), ProductStatus.AVAILABLE, 1,1L);
